...
public class FogExample {

    public static SimulatorJobResult sim(double sigmoidLambda) throws Exception{
        SimLogger.setLogging(1, true);

        String cloudfile = "D:\\ora\\ttik_pti\\szakdoga\\projek\\DISSECT-CF-Fog\\simulator\\src\\main\\resources\\demo\\LPDS_original.xml";
        ...
        Application application1 = new Application("App-1", 1 * 60 * 1000, 250, 2500, false,
                new PliantApplicationStrategy(0.9, 2.0, sigmoidLambda), instance3);
        Application application2 = new Application("App-2", 1 * 60 * 1000, 250, 2500, true,
                new PliantApplicationStrategy(0.9, 2.0, sigmoidLambda), instance2);
        Application application3 = new Application("App-3", 1 * 60 * 1000, 250, 2500, true,
                new PliantApplicationStrategy(0.9, 2.0, sigmoidLambda), instance1);
        ...
        var result = ScenarioBase.logBatchProcessing(stoptime - starttime);
